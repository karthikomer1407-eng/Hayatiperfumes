      ...
      <header className={`navbar ${scrolled ? "scrolled" : ""}`} id="navbar">
        ...
        <nav className="desktop-nav">
          <ul className="nav-links">
            ...
            <li>
              <a href="#collection-section" className="nav-link">
                Royal Treasury
              </a>
            </li>
            <li>
              <a href="#heritage-section" className="nav-link">
                Two Worlds
              </a>
            </li>
            <li>
              <a href="#alchemist-section" className="nav-link">
                Scent Alchemist
              </a>
            </li>
            <li>
